# MAGI UNIFIED SYSTEM CONSTITUTION v2.4

文書バージョン: v2.4
発効日: 2026-05-22
前バージョン: v2.2 (2026-04-26)
...
PLM群の思考と取引結果を、訓練データとして使用可能な形でBigQueryに蓄積する層。
...
- Job: `magi-core-together`
- 特性: 群衆心理に逆らい、過剰反応された銘柄を狙う
- 状態: 停止中(再開判断保留)
- 旧名: ORACLE(2026-05-22改名、HERMES:ORACLE との命名衝突回避)
...
- 注記: PLMユニットの NIRVANA(旧ORACLE)とは別物、HERMES機関の構成要素
...
14. **PLM unit の NIRVANA と HERMES:ORACLE を同じものとして扱う**(別物、2026-05-22改名)
...
- AUTONOMOUS TRADING UNITS を v9.23 実態反映(TIARA削除、ORACLE->NIRVANA改名、LILITH PLM追加、PAUSED/学習専用表記)
...
- 次回改訂: v2.5 候補事項(Watchlist VIX統合完了、LILITH Cutover完了、Phase B0 訓練完了 等の節目)
