...
- **米国株特化**: 米国市場(NYSE 通常取引時間 = 09:30-16:00 `America/New_York`〈ET〉。MAGI 全体でこの ET を時刻基準とする。UTC 換算は DST により±1時間変動し、EDT 期は 13:30-20:00 UTC、EST 期は 14:30-21:00 UTC となる)、米国上場銘柄(`lib/symbols.js`の54銘柄)に絞ることで、多通貨・多市場の複雑性を排除し蒸留効率を最大化する
...
- スケジュール: 平日 1日4回。現状は UTC 固定(14:46/16:46/18:46/20:46)で、ET 換算は DST により±1時間変動する(EDT 期 = 10:46/12:46/14:46/16:46 ET、EST 期 = 09:46/11:46/13:46/15:46 ET)。NYSE セッションに対して固定したい場合は `America/New_York` 基準へ移行する
- 対象: 9 symbols
...
- スケジュール: 現状 UTC 固定(13:00, 14:00 月-金, premarket)。ET 換算は DST により±1時間変動する(EDT 期 = 09:00/10:00 ET、EST 期 = 08:00/09:00 ET)
...
- 米国市場時間内(09:30-16:00 `America/New_York`〈ET〉。UTC 換算は DST で変動 — 第2章 NORTH STAR 参照)のみ
- 54銘柄リスト外への取引不可
- 上記第11章の自律性原則の境界線に従う
